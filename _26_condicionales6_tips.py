# -*- coding: utf-8 -*-
"""
Created on Sat Mar 11 12:33:55 2023
...
print("no te manches carnal ese numero ni existe es negativo") if entrada <= 0 else print(' ')
print("no te manches carnal ese numero ni existe") if entrada >4 else print(' ')
